...
import io.gumga.viagem.application.service.MovimentoService;
...
@Transactional
public class MovimentoAPI extends GumgaAPI<Movimento, String> {


    @Autowired
    public MovimentoAPI(GumgaService<Movimento, String> service) {
        super(service);
    }
