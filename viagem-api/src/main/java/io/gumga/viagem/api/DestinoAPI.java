...
import io.gumga.viagem.application.service.DestinoService;
...
@Transactional
public class DestinoAPI extends GumgaAPI<Destino, Long> {


    @Autowired
    public DestinoAPI(GumgaService<Destino, Long> service) {
        super(service);
    }
