...
import io.gumga.viagem.application.service.PessoaService;
...
public class PessoaAPI extends GumgaAPI<Pessoa, String> {
    ...
    public RestResponse<Pessoa> save(@RequestBody @Valid Pessoa obj, BindingResult result) {
        if (obj.getFoto() != null) {
    ...
    public RestResponse<Pessoa> update(String id, @RequestBody @Valid Pessoa obj, BindingResult result) {
        if (obj.getFoto()!= null) {
