package io.gumga.viagem.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import io.gumga.viagem.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "io.gumga.viagem");
