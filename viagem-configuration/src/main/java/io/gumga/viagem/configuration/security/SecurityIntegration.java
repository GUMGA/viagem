...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(io.gumga.viagem.configuration.security.SecurityIntegration.class);
