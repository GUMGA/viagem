...
<body ng-controller="manyToOneCtrl">
  ...
  <div class="gumga-layout">
    <form name="Example">
      ...
      <div class="col-md-12">
        <div class="col-md-12">
          <gumga-list data="pessoa.data" name="pessoa2" configuration="tableConfig" page-size="pessoa.pageSize" page-position="bottom"
            page-align="flex-end" count="pessoa.count" page-model="page" sort="createQuery(page, pessoa.pageSize, field, dir)"
            on-row-change="update(row)" on-page-change="createQuery(page, pageSize, field, dir)">
          </gumga-list>
        </div>
      </div>
